import { StyleSheet, Image, Platform, View, Text, ScrollView, SafeAreaView, TextInput, Button } from 'react-native';
...
export default function MainPartCalculators({bgColor, textColor}: MainPartHomeProps) {
      ...
      <View style={{gap: windowAverage * 4, flexDirection: "row", alignItems: "center"}}>
        ...
        <View style={[styles.select__container, {}]}>
          <Picker
            ...
            onValueChange={(itemValue, itemIndex) => setRepeats(itemValue)}>
